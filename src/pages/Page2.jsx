...
<h3 className='text-gray-400 text-xl mt-8 text-center font-[anzo]'>©  anzo.studio 2024 | designed and developed</h3>

<div className='rotateText mt-28'>
<h1 className='text-[40vw] font-[anzo5] text-center leading-[33vw]'>IMPACTFUL</h1>
</div>
   
<div>
<h1 className='rotateText text-[40vw] font-[anzo5] text-center leading-[33vw]'>DESIGN</h1>
</div>     
   
<div>
<h1 className='rotateText text-[40vw] font-[anzo5] text-center leading-[33vw]'>IS THE</h1>
</div>    
...
<div>
<h1 className='rotateText text-[40vw] font-[anzo5] text-center leading-[33vw]'>THAT</h1>
</div>     
   
<div>
<h1 className='rotateText text-[40vw] font-[anzo5] text-center leading-[33vw]'>WORKS</h1>
</div>    


       

        <div className='flex items-center justify-center ml-52 mr-52 scale-75'>
    ...
    <g>
        ...
        <div className='h-1 w-1/4 mt-10 bg-black left-1/2 relative -translate-x-1/2 '></div>
        </div>
   </>
  )
}
